...
function sweetTooth(totalNoOfSweets,sweetsConsumedByKaren,SweetsComsumedInMeters,metersToTravel){
    var remaining = (totalNoOfSweets-(sweetsConsumedByKaren+SweetsComsumedInMeters*metersToTravel))/2;
    return remaining;
}
//Trial 5:
